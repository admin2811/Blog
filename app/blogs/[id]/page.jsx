  ...
  return ( data ? <>
    <div className='bg-gray-200 py-5 px-5 md:px-12 lg:px-28'>
      ...
      <Link href='/'>
        ...
        <button className='flex items-center gap-2 font-medium py-1 px-3 sm:py-3 sm:px-6 border border-black shadow-custom-black'>
    ...
    <div className='mx-5 max-w-[800px] md:mx-auto mt-[-100px] mb-10'>
      ...
      {fileUrl && (
          <div className="my-10">
            ...
            <DocViewer documents={[{ uri: fileUrl }]} pluginRenderers={DocViewerRenderers} width={100} height={100}/>
          </div>
        )}
      <div className='my-24'>
